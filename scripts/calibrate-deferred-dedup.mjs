...
// reports recall + audit-ledger shape. Run this BEFORE changing
// CLUSTER_SHARED_STEPS/FUZZY_MIN_TOKENS, and after: thresholds must be
// recalibrated against measurement, never intuition.
